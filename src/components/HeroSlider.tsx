    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="tel:3212095447" className="inline-flex items-center justify-center gap-2 bg-flame hover:bg-flame/90 text-primary-foreground font-semibold px-8 py-4 rounded-lg transition-all duration-200 text-lg shadow-flame">
